...
Description:
------------
This module displays a message when you save a node, which is not published.
The message contains the URL to the node, with a special hash value. This 
URL can be used to allow access to the node to unauthorised accounts.
...
Author:
-------
aberg (http://drupal.org/user/341657)
